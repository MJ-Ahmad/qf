...
def main():
    ...
    # Handle nested structures sometimes returned by upstream data files
    ...
    print("Division count approx: 8")
    print("District count approx: 64")
    print("Upazila count approx: 495-499 depending on source version")
